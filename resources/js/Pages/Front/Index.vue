...
<template>
  ...
  <nav class="bg-white border-gray-200">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between lg:mx-32 p-4">
        <img src="../../Components/images/LOGO1.png" class="h-20 mr-3" alt="Aulia" />
      <button
          ...
          <li>
            <div v-if="canLogin">
              <Link
                ...
                class="text-white bg-green-400 hover:bg-green-400 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0">
                Dashboard
              </Link>
              <template v-else>
                <Link :href="route('login')" type="button" class="text-white bg-green-400 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm px-4 py-2 text-center mr-3 md:mr-0"> Log in</Link>
              </template>
            </div>
          </li>
        </ul>
      ...
      <div class="flex flex-col-reverse lg:flex-row items-center lg:py-5 lg:order-first">
        <div class="lg:w-6/12 lg:ms-10 text-black">
          <div v-for="item in skill" :key="item.id">
            ...
            <p v-if="item && item.konten" class="text-lg text-black">
              {{ item.konten }}
            </p>
          </div>
          <div class="grid grid-cols-1 gap-2 md:flex md:justify-start">
            <button type="button" class="bg bg-green-400 hover:bg-green-400 text-black rounded-lg px-4 py-2 mt-7">Primary</button>
      ...
      <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
        <div className="sm:col-span-12 lg:col-span-3">
          ...
          <div className="text-sm text-gray-600">
            <img src="../../Components/images/LOGO1.png" class="h-20 mr-3" alt=" Logo" />
            <span class="self-center text-2x font-serif whitespace-nowrap text-black uppercase">Laili Aulia Fitri</span>
          </div>
        </div>
